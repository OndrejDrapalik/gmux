...
COPY --chown=dev:dev dotfiles/config/gmux/templates/ /home/dev/.config/gmux/templates/
COPY --chown=dev:dev dotfiles/config/tmux-gmux/templates/ /home/dev/.config/tmux-gmux/templates/
